...
def load_splirent_model(sequence_padding, drop=0.2) :
    ...
    layer_dense_2 = Dense(512, activation='relu')
    ...
    return [ ('splirent_only_random_regions_large_drop_' + str(drop).replace(".", "") + '_wider_hek_mcf7', splicing_model), ('loss', loss_model) ]
