...
def load_splirent_model(sequence_padding, drop=0.2) :
    ...
    dense_out_hek = layer_dense_hek(shared_out)
    dropped_out_hek = layer_drop_hek(dense_out_hek)
    dense_out_mcf7 = layer_dense_mcf7(shared_out)
    ...
    return [ ('splirent_drop_' + str(drop).replace(".", "") + '_sep_hek_mcf7', splicing_model), ('loss', loss_model) ]
