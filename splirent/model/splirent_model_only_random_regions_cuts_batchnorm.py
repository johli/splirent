...
def load_splirent_model(sequence_padding, drop=0.2) :
    ...
    dense_out = relu_dense(batch_norm_dense(layer_dense(concat_out)))
    ...
    return [ ('splirent_only_random_regions_cuts_batchnorm_drop_' + str(drop).replace(".", ""), splicing_model), ('loss', loss_model) ]
